"""
autopilot/engines/remediation_engine.py
──────────────────────────────────────────
...
from autopilot.config import OperatorConfig, OperatorMode
from autopilot.engines.approval_engine import ApprovalDecision, ApprovalEngine
from autopilot.engines.diagnosis_engine import Diagnosis
...
from autopilot.utils.circuit_breaker import CircuitBreaker
...
class RemediationEngine:
    ...
    async def handle(
        ...
        try:
            ...
            logger.exception(
                "Action %s raised exception for %s: %s", action.action, resource_id, exc
            )
