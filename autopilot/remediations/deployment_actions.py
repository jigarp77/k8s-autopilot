"""
autopilot/remediations/deployment_actions.py
─────────────────────────────────────────────
    ...
    **kwargs,
    ...
    return ActionResult(
        ...
        message=(
            ...
            if ok
            else f"Failed to roll back deployment {namespace}/{name}"
        ),
    )
    ...
    **kwargs,
    ...
    return ActionResult(
        ...
        message=(
            ...
            if ok
            else f"Failed to restart deployment {namespace}/{name}"
        ),
    )
    ...
    **kwargs,
    ...
    return ActionResult(
        ...
        message=(
            ...
            if ok
            else f"Failed to scale deployment {namespace}/{name}"
        ),
