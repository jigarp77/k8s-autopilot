"""
autopilot/integrations/slack.py
────────────────────────────────
...
from autopilot.config import SlackConfig
from autopilot.engines.diagnosis_engine import Diagnosis, RemediationAction, Severity
...
class SlackClient:
    ...
    async def post_incident_notification(
        ...
        blocks = [
            ...
            {"type": "divider"},
            {"type": "section", "text": {"type": "mrkdwn", "text": action_text}},
            {
                "type": "context",
                "elements": [
                    {
                ...
                "elements": [
                    {
                        ...
                        "text": (
                            ...
                            f"Auto-rejects in {self._config.timeout_seconds}s"
                        ),
                    }
                ],
            },
        ...
        blocks = [
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": (
                        f"{emoji} *{decision_str.upper()}*{decided_text} — Approval `{approval_id}`"
                    ),
                },
            }
        ]
